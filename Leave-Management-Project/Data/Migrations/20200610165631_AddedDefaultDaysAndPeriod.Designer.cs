...
namespace Leave_Management_Project.Data.Migrations
{
    ...
    [Migration("20200610165631_AddedDefaultDaysAndPeriod")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Leave_Management_Project.Data.LeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_Project.Data.LeaveHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_Project.Data.LeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_Project.Models.LeaveTypeViewModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Leave_Management_Project.Data.Employee", b =>
                {
            ...
            modelBuilder.Entity("Leave_Management_Project.Data.LeaveAllocation", b =>
                {
                    b.HasOne("Leave_Management_Project.Data.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Leave_Management_Project.Data.LeaveType", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("Leave_Management_Project.Data.LeaveHistory", b =>
                {
                    b.HasOne("Leave_Management_Project.Data.Employee", "ApprovedBy")
                        .WithMany()
                    ...
                    b.HasOne("Leave_Management_Project.Data.Employee", "RequestingEmployee")
                        .WithMany()
